          ...
          <div className={active ? "links" : "links hide"}>
            ...
            <button className={pathname === '/uslugi' ? 'uslugi-hover active' : 'uslugi-hover'} to='/uslugi'>Услуги
              <div className='uslugi'>
                <button to='/physical' onClick={() => navigate('/')} className={pathname === '/physical' ? 'active' : 'uslugulink'}>Физическим лицам</button>
                <button to='/yuridik' onClick={() => navigate('/')} className={pathname === '/yuridik' ? 'active' : 'uslugilink'}>Юридическим лицам</button>
              </div>
            </button>
